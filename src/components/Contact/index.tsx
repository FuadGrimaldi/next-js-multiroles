  ...
  return (
    <>
      ...
      <section id="support" className="px-4 lg:px-[120px]">
        <div className="relative mx-auto px-4 py-10 lg:px-15 lg:py-15 xl:px-20 xl:py-20 ">
          <div className="absolute left-0 top-0 -z-1 h-2/3 w-full rounded-lg bg-gradient-to-t from-transparent to-[#dee7ff47] mt-[130px] lg:mt-[110px] "></div>
          ...
          <div className="flex flex-col-reverse gap-8 md:flex-row md:justify-between xl:gap-20 lg:mt-[110px] mt-[130px]">
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-full rounded-lg bg-white p-5 md:p-[50px] shadow-solid-8 lg:w-3/4"
            >
