    ...
    <>
      <div className="flex flex-col border-b border-stroke last-of-type:border-none">
        <button
          ...
          className="flex cursor-pointer items-center justify-between px-2 py-5 text-metatitle3 font-medium lg:text-xl text-lg text-black lg:px-9 lg:py-7.5"
        >
          {quest}
        ...
        <p
          className={`text-lg text-gray-500 border-t border-stroke px-2 py-5 lg:px-9 lg:py-7.5 ${
